...
import editGrantEpoch from "./edit-grant-epoch";
import editBound from "./edit-bound";
...
gateRouter.get("/doc/:docId/edit-grant-epoch", asyncHandlerArray(editGrantEpoch));
gateRouter.post("/doc/:docId/edit-bound", asyncHandlerArray(editBound));
